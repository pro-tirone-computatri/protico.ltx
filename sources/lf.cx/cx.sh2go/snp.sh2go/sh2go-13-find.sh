...
#
# In diesem Ordner finden sich auch andere als die reinen Aufgabendateien. Die müssen durch einen
# geschickter gesetzten Suchparameter als *.sh ausgegrenz werden.
