...
\begin{frame}[fragile]  
  \frametitle{LF03:08:Exkurs:Bitweise Verknüpfung}
  \begin{center}
    \begin{minipage}{0.9\textwidth}
      \inputminted[fontsize=\footnotesize,linenos]{python}{\snpLf/dm-0308-bitmask.py}
    \end{minipage}
  \end{center}
\end{frame}

\begin{frame}[fragile]  
  \frametitle{LF03:08:Exkurs:Bitweise Operatoren}
  \vspace{0.2cm}
...
\begin{frame}[fragile]  
  \frametitle{LF03:08:Exkurs:Bitweise Operatoren}
    ...
    \begin{minipage}{0.9\textwidth}
      ...
      \inputminted[fontsize=\footnotesize,linenos]{python}{\snpLf/dm-0308-int-remains-int.py}
...
\begin{frame}[fragile]  
  \frametitle{LF03:08:Exkurs:Logische Operatoren}
  \vspace{0.2cm}
...
\begin{frame}[fragile]  
  \frametitle{LF03:08:Exkurs:Logische Wahrheitswertetabelle}
  \vspace{0.2cm}
