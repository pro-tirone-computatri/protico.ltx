...
* Existenz von IP-Adressen heute Allgemeinwissen
* Sinn und Zweck ihrer Struktur eher nicht.

Deshalb dazu ein 'Spiel':

---
 
<!-- uebung::start -->
<span style="color: green;">_ÜBUNG_</span> <span style="color:magenta;">**LF03:06-Addressing:01**</span>
...
* [ ] wähle ein dazu passendes Verfahren, um - auf Zuruf - eine Nachrichtvon einem beliebigen Mitglied zu einem anderen zu übermitteln.
...
* [ ] Passen Sie Ihre Gruppenstruktur jetzt so an, dass Sie von eine Nachricht von einem beliebigen Mitglied aus GA an ein belibiges Mitglied in GB senden können.
...
Danach sammeln alle gemeinsam die notwendigen Änderungen:

| Aktion | GA | GB | GC
|---|---|---|---|
| Änderung der inneren Struktur | [\_] | [\_] | [X] |
| Erweiterung bei gleicher innerer Struktur | [\_] | [\_] | [\_] |
| Änderung des Nachrichtenformates | [\_] | [\_] | [\_] |
| Änderung des Adressierungssystems | [\_] | [\_]  | [\_] |
| Änderung der Adressen | [\_] | [\_]  | [\_] |

**Ankündigung:**

* Das tatsächliche (IP-)Adresssystem wurde von Anfang an so ausgelegt, dass derartige Änderungen ohne den Aufwand und die strukturellen Eingriffe auskommen, der während obiger Übung sichtbar wird. 
* Das ist der Charme des Systems.
* Deshalb funktioniert das Internet in dieser Hinsicht immer noch so wie vor 30 Jahren und länger.
* Deshalb lernen wir auch heute noch die Systematik von IPv4-Netzen und IPv6-Netzen
