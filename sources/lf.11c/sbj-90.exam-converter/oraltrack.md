...
**_Lösung zu Step 01:_** **[→ ZP:Sheet:2]**
...
**_Lösung zu Step 02:_** **[→ ZP:Sheet:2]**
...
**_Lösung zu Step 03:_** **[→ ZP:Sheet:3]**
...
* [ ] Programmieren Sie jetzt in Python einen Konverter, der die (syntaktisch und semantisch bereinigten) Inputdaten in dem Format aus einer Datei einliest, das Sie selbst in Step 1 festgelegt haben (= im Folgenden: *Step1Format*). Als Erstes soll er sie auch nur in diesem *Step1Format* eine andere Datei zurückschreiben:
  * [ ] **MVP**:
    ...
    * [ ] Schreiben Sie das Programmskelett mit 'leeren Funktionen'
  * [ ] **VP-0.1**:
    * [ ] Programmieren Sie einen Output-Adapter für Ihren Konverter, der die *hard-gecodeten Testdaten* im *Step1Format* in eine Datei schreibt. **(4P)**
    ...
    * [ ] Überprüfen Sie dann, ob Ihr Programm auch die gesamten bereinigten Inputdaten im *Step1Format* einlesen und im *Step1Format* in eine andere Datei wieder ausgibt.
    * [ ] Kommentieren Sie Ihr Programm kurz, aber aussagekräftig. **(1P)**

<!-- uebung::end -->

**_Lösung zu Step 04:_** **[→ ZP:Sheet:4]** & **[→ ZP:Sheet:5]**
...
* [ ] Programmieren Sie in Python einen Konverter, der bereinigten Inputdaten [*Step1Format*] aus einer Datei einliest und in anderen Formate in eine andere Datei ausgibt.
  * [ ] **VP-0.2**:
    * [ ] Programmieren Sie einen zweiten Output-Adapter für Ihren Konverter, der die *hard-gecodetet Testdaten* im CSV-Format in eine Datei schreibt. **(1P)**
  * [ ] **VP-1.0**:
    * [ ] Programmieren Sie einen dritten Output-Adapter für Ihren Konverter, der die *hard-gecodetet Testdaten* im JSON-Format in eine Datei schreibt. **(4P)**
    * [ ] Modifizieren Sie Ihren Konverter so, dass er seinen Nutzer das Ausgabeformat wählen lässt. **(1P)**
    * [ ] Überprüfen Sie dann, ob Ihr Programm auch die gesamten bereinigte Inputdaten [*Step1Format*] einlesen und im JSON-Format und im CSV-Format in eine andere Datei ausgeben kann.
    * [ ] Kommentieren Sie Ihr Programm kurz, aber aussagekräftig. **(1P)**

<!-- uebung::end -->

**_Lösung zu Step 05:_** **[→ ZP:Sheet:6]** & **[→ ZP:Sheet:7]** & **[→ ZP:Sheet:8]**
...
**_Lösung zu Step 06:_** **[→ ZP:Sheet:9]**

1. Enkodiere den Shall- und den is-Wert in dasselbe 2-Byte-Integer
2. Schreibe die Shall-is-Integer in die kondensierte csv-Datei
...
* **[→ ZP:Sheet:10]**
* Auffälligkeit: Nutzer startet hoch, überfordert sich, kann Level nicht halten.
