...
\begin{frame}  
  \frametitle{LF[11,12]c:00:Curriculum}
...
\begin{frame}  
  \frametitle{LF[11,12]c:00:Curriculum:Entscheiderinnen}
  \begin{center}
...
\begin{frame}  
  \frametitle{LF[11,12]c:00:Curriculum:Entscheidungsbeispiel}
...
\begin{frame}  
  \frametitle{LF[11,12]c:00:Curriculum:Fragmentierung}
...
\begin{frame}
  \frametitle{LF[11,12]c:00:Curriculum:supraförderal}
  \begin{figure}
...
\begin{frame}
  \frametitle{LF[11,12]c:00:Curriculum:supranational}
  \begin{figure}
...
\begin{frame}
  \frametitle{LF[11,12]c:00:Curriculum:Gendern}
  \begin{figure}
...
\begin{frame}
  \frametitle{LF[11,12]c:00:Curriculum:KMK-Entscheidung}
  \begin{figure}
...
\begin{frame}
  \frametitle{LF[11,12]c:00:Curriculum:Lernfelder}
  \begin{figure}
...
\begin{frame}
  \frametitle{LF[11,12]c:00:Curriculum:Prüfungskataloge}
  \begin{columns}
    \column{0.7\textwidth}
      Prüfungskataloge
      \begin{itemize}
