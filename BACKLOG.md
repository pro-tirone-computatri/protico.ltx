...
* [ ] Write LF12c lessons 
* [ ] Write LF12d lessons
* [ ] Write cross-over lessons about
  * [ ] self-organization
  * [x] installing and using `VSCode` (WIN) and `VSCodium` (LNX)
  * [x] installing and using `drawio`
  * [x] using `Markdown`
...
* [x] insert in lf.tpl a collecting routine to compile the complete LF zp based on the LF-sbj-zps and their theme-zps 
* [x] insert in lf.tpl a collecting routine to compile the complete LF exercises, oraltracks, and playbooks based on the sbj/theme subfiles 
* [x] backport these routines to all specified LFs in `sources`
